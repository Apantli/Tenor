...
export const getTasksForKanbanProcedure = protectedProcedure
  ...
  .query(async ({ ctx, input }) => {
    ...
    const activeColumns = await getAllStatuses(ctx.firestore, input.projectId);
 ...
 */
export const createStatusListProcedure = protectedProcedure
  .input(
    z.object({
      projectId: z.string(),
      name: z.string(),
...
export const getItemAutomaticStatusProcedure = protectedProcedure
  ...
  .query(async ({ ctx, input }) => {
    ...
    const activeStatuses = await getAllStatuses(ctx.firestore, input.projectId);
...
export const kanbanRouter = createTRPCRouter({
  ...
  createStatusList: createStatusListProcedure,
