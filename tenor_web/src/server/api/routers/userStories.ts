 ...
 */
export const createUserStoryProcedure = protectedProcedure
  .input(
    z.object({
      projectId: z.string(),
 ...
 */
export const getProjectUserStoriesOverviewProcedure = protectedProcedure
 ...
 */
export const getUserStoriesTableFriendlyProcedure = protectedProcedure
  .input(z.object({ projectId: z.string() }))
  .query(async ({ ctx, input }) => {
    ...
    const fixedData = await Promise.all(
      rawUs.map(async (userStory) => {
        ...
        const epic = await getEpic(ctx.firestore, projectId, userStory.epicId);
 ...
 */
export const getUserStoryDetailProcedure = protectedProcedure
  ...
  .query(async ({ ctx, input }) => {
    ...
    if (userStoryData.priorityId !== undefined) {
      priorityTag = await getPriorityTag(settingsRef, userStoryData.priorityId);
    }
 ...
 */
export const getAllUserStoryPreviewsProcedure = protectedProcedure
  .input(
    z.object({
      projectId: z.string(),
    }),
 ...
 */
export const modifyUserStoryProcedure = protectedProcedure
  .input(
    z.object({
      projectId: z.string(),
 ...
 */
export const modifyUserStoryTagsProcedure = protectedProcedure
  .input(
    z.object({
      projectId: z.string(),
      userStoryId: z.string(),
 ...
 */
export const deleteUserStoryProcedure = protectedProcedure
  .input(
    z.object({
      projectId: z.string(),
      userStoryId: z.string(),
 ...
 */
export const generateUserStoriesProcedure = protectedProcedure
  .input(
    z.object({
      projectId: z.string(),
      amount: z.number(),
...
`;
    ...
    const parsedData = await Promise.all(
      data.map(async (userStory) => {
        ...
        if (userStory.priorityId !== undefined && userStory.priorityId !== "") {
...
export const userStoriesRouter = createTRPCRouter({
  ...
  getProjectUserStoriesOverview: getProjectUserStoriesOverviewProcedure,
  getUserStoriesTableFriendly: getUserStoriesTableFriendlyProcedure,
  getUserStoryDetail: getUserStoryDetailProcedure,
  getAllUserStoryPreviews: getAllUserStoryPreviewsProcedure,
