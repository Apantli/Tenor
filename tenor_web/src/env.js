...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    FIREBASE_AUTH_EMULATOR_HOST: process.env.FIREBASE_AUTH_EMULATOR_HOST, // must be called exactly this because it is used internally by firebase to connect to the emulator
