...
export default function Dropdown<T extends string>({
  ...
  return (
    <div className="relative flex items-center justify-center" ref={ref}>
      ...
      <div
        className={cn(
          "absolute right-0 top-full mt-2 flex w-40 origin-top-right scale-x-50 scale-y-0 flex-col gap-0 overflow-hidden rounded-lg border border-app-border bg-white text-app-text opacity-0 shadow-lg transition",
          {
